...
let statusClass = document.getElementById("hero") as HTMLDivElement;
let fragment = document.createDocumentFragment();
const firstTitleArticles = document.getElementById("firstTitleArticles") as HTMLElement;
const secondTitleArticles = document.getElementById("secondTitleArticles") as HTMLElement;
const firstContainerBtn = document.getElementById("firstContainerBtn") as HTMLDivElement;
const secondContainerBtn = document.getElementById("secondContainerBtn") as HTMLDivElement;
const firstContainerCard = document.getElementById("firstContainerCard") as HTMLDivElement;
const secondContainerCard = document.getElementById("secondContainerCard") as HTMLDivElement;
...
const heroP = document.querySelector(".hero-p") as HTMLParagraphElement;
const firstSvg = document.getElementById("firstSvg") as HTMLDivElement;
const secondSvg = document.getElementById("secondSvg") as HTMLDivElement;
const spinnerBg = document.getElementById("spinnerBg") as HTMLDivElement;
const spinner = document.getElementById("spinner") as HTMLDivElement;


// store the news titles related to their corresponding section
const titleSectionHome: any[] = [];
const titleSectionNews: any[] = [];
const titleSectionHealth: any[] = [];
const titleSectionScience: any[] = [];
const titleSectionMagazine: any[] = [];
var timer: any;
...
function generateHomeSection() {
  ...
  objNews.forEach((news) => {
    ...
    pSection.innerHTML += `Section: ${
      sectStr.charAt(0).toUpperCase() + sectStr.slice(1)
    }`;
...
function generateHealthSection() {
  ...
  objNewsHealth.forEach((newsHealth: any) => {
...
function generateScienceSection() {
  ...
  objNewsScience.forEach((newsScience: any) => {
...
function generateMagazineSection() {
  ...
  objNewsMagazine.forEach((newsMagazine: any) => {
...
export function renderMatchingObject(o: any, sect: string, input: string) {
  switch (sect) {
    case "home":
    ...
    case "health":
      ...
      pSectionHealth.innerHTML += `Section: ${
        sectStrSectHealth.charAt(0).toUpperCase() + sectStrSectHealth.slice(1)
      }`;
    ...
    case "science":
      ...
      pSectionScience.innerHTML += `Section: ${
        sectStrSectScience.charAt(0).toUpperCase() + sectStrSectScience.slice(1)
      }`;
    ...
    case "magazine":
      ...
      pSectionMagazine.innerText += `Section: ${
        sectStrSectMagazine.charAt(0).toUpperCase() +
